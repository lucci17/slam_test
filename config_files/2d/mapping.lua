...
TRAJECTORY_BUILDER_2D.submaps.resolution = 0.04
...
POSE_GRAPH.optimize_every_n_nodes = TRAJECTORY_BUILDER_2D.submaps.num_range_data
POSE_GRAPH.constraint_builder.log_matches = false
-- POSE_GRAPH.constraint_builder.min_score = 0.7

-- 下面这条是 google Cartographer 开发人员的调试参数，后面再尝试是否可行 TODO
POSE_GRAPH.constraint_builder.ceres_scan_matcher = TRAJECTORY_BUILDER_2D.ceres_scan_matcher
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher.branch_and_bound_depth = 9

POSE_GRAPH.optimization_problem.consecutive_node_rotation_weight = 2e6
POSE_GRAPH.optimization_problem.consecutive_node_translation_weight = 1e4
-- POSE_GRAPH.optimization_problem.rotation_weight = 2e3
