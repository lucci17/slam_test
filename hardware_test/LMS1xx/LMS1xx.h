...
public:
  ...
  * After receiving this command LMS1xx unit starts spinning laser and
  * measuring.
  */
  void startMeas();
  ...
  * After reception of this command device start or stop continuous data stream
  * containing scan messages.
  ...
  * @return true if scan was read successfully, false if error or timeout. False
  * implies that higher level
  ...
  * Parameters are saved in the EEPROM of the LMS and will also be available
  * after the device is switched off and on again.
  *
  */
  void saveConfig();
