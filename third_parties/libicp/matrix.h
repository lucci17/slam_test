...
public:
  ...
  inline void setValWithIndex(FLOAT s, int32_t i, int32_t j)
  {
	if( i < 0 || j < 0 || i > m-1 || j > n-1 )
	{
		std::cerr << "ERROR in setVal" << std::endl;
		exit(-1);
	}
...
#ifdef MATRIX_USE_SYCL
  static cl::sycl::default_selector selector_;
  static cl::sycl::queue sycl_queue_;
#endif
