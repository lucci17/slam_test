...
//   cout << (Matrix::ones(active.size(),1)*mu_m).val[active.size()-1][0] << " " << (Matrix::ones(active.size(),1)*mu_m).val[active.size()-1][1] << endl;  
//   
//   cout << "q_m: " << q_m.val[active.size()-1][0] << " " << q_m.val[active.size()-1][1] << endl;
//   cout << "q_t: " << q_t.val[active.size()-1][0] << " " << q_t.val[active.size()-1][1] << endl;
