...
#include "cartographer/mapping_3d/pose_graph/proto/constraint_builder_self_adjust.pb.h"

namespace cartographer {
namespace mapping_3d {
namespace pose_graph {
	
proto::ConstraintBuilderSelfAdjust CreateConstraintBuilderSelfAdjustOptions(
...
class ConstraintBuilder {
 ...
 private:
  ...
  mapping::pose_graph::proto::ConstraintBuilderOptions options_;
  ...
  // add by Edward.Liu
  int count_too_few_constraints_ = 0;
  int count_too_many_constraints_ = 0;
};
