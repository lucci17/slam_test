...
#ifndef PROTOBUF_cartographer_2fmapping_2fpose_5fgraph_2fproto_2foptimization_5fproblem_5foptions_2eproto__INCLUDED
#define PROTOBUF_cartographer_2fmapping_2fpose_5fgraph_2fproto_2foptimization_5fproblem_5foptions_2eproto__INCLUDED
...
class OptimizationProblemOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.pose_graph.proto.OptimizationProblemOptions) */ {
 public:
  ...
  void clear_consecutive_node_translation_weight();
  static const int kConsecutiveNodeTranslationWeightFieldNumber = 2;
  double consecutive_node_translation_weight() const;
  void set_consecutive_node_translation_weight(double value);

  // double consecutive_node_rotation_weight = 3;
  void clear_consecutive_node_rotation_weight();
  static const int kConsecutiveNodeRotationWeightFieldNumber = 3;
  double consecutive_node_rotation_weight() const;
  void set_consecutive_node_rotation_weight(double value);
  ...
  // bool use_online_imu_extrinsics_in_3d = 13;
  void clear_use_online_imu_extrinsics_in_3d();
  static const int kUseOnlineImuExtrinsicsIn3DFieldNumber = 13;
  ...
  // @@protoc_insertion_point(class_scope:cartographer.mapping.pose_graph.proto.OptimizationProblemOptions)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::cartographer::common::proto::CeresSolverOptions* ceres_solver_options_;
  double huber_scale_;
  double consecutive_node_translation_weight_;
  double consecutive_node_rotation_weight_;
  ...
  friend struct protobuf_cartographer_2fmapping_2fpose_5fgraph_2fproto_2foptimization_5fproblem_5foptions_2eproto::TableStruct;
};
// ===================================================================
...
// double consecutive_node_translation_weight = 2;
inline void OptimizationProblemOptions::clear_consecutive_node_translation_weight() {
  consecutive_node_translation_weight_ = 0;
}
inline double OptimizationProblemOptions::consecutive_node_translation_weight() const {
...
inline void OptimizationProblemOptions::set_consecutive_node_translation_weight(double value) {
...
// double consecutive_node_rotation_weight = 3;
inline void OptimizationProblemOptions::clear_consecutive_node_rotation_weight() {
  consecutive_node_rotation_weight_ = 0;
}
inline double OptimizationProblemOptions::consecutive_node_rotation_weight() const {
...
inline void OptimizationProblemOptions::set_consecutive_node_rotation_weight(double value) {
...
inline bool OptimizationProblemOptions::use_online_imu_extrinsics_in_3d() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.pose_graph.proto.OptimizationProblemOptions.use_online_imu_extrinsics_in_3d)
...
inline void OptimizationProblemOptions::set_use_online_imu_extrinsics_in_3d(bool value) {
  ...
  // @@protoc_insertion_point(field_set:cartographer.mapping.pose_graph.proto.OptimizationProblemOptions.use_online_imu_extrinsics_in_3d)
}
...
#endif  // PROTOBUF_cartographer_2fmapping_2fpose_5fgraph_2fproto_2foptimization_5fproblem_5foptions_2eproto__INCLUDED
