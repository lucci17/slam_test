...
// source: cartographer/mapping_2d/proto/motion_filter_options.proto

#ifndef PROTOBUF_cartographer_2fmapping_5f2d_2fproto_2fmotion_5ffilter_5foptions_2eproto__INCLUDED
#define PROTOBUF_cartographer_2fmapping_5f2d_2fproto_2fmotion_5ffilter_5foptions_2eproto__INCLUDED
...
namespace protobuf_cartographer_2fmapping_5f2d_2fproto_2fmotion_5ffilter_5foptions_2eproto {
...
class MotionFilterOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping_2d.proto.MotionFilterOptions) */ {
 public:
  MotionFilterOptions();
  ...
  // @@protoc_insertion_point(class_scope:cartographer.mapping_2d.proto.MotionFilterOptions)
 private:
  ...
  friend struct protobuf_cartographer_2fmapping_5f2d_2fproto_2fmotion_5ffilter_5foptions_2eproto::TableStruct;
};
// ===================================================================
...
inline double MotionFilterOptions::max_time_seconds() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping_2d.proto.MotionFilterOptions.max_time_seconds)
  return max_time_seconds_;
}
inline void MotionFilterOptions::set_max_time_seconds(double value) {
  
  max_time_seconds_ = value;
  // @@protoc_insertion_point(field_set:cartographer.mapping_2d.proto.MotionFilterOptions.max_time_seconds)
}
...
inline double MotionFilterOptions::max_distance_meters() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping_2d.proto.MotionFilterOptions.max_distance_meters)
...
inline void MotionFilterOptions::set_max_distance_meters(double value) {
  ...
  // @@protoc_insertion_point(field_set:cartographer.mapping_2d.proto.MotionFilterOptions.max_distance_meters)
}
...
inline double MotionFilterOptions::max_angle_radians() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping_2d.proto.MotionFilterOptions.max_angle_radians)
  return max_angle_radians_;
}
inline void MotionFilterOptions::set_max_angle_radians(double value) {
  
  max_angle_radians_ = value;
  // @@protoc_insertion_point(field_set:cartographer.mapping_2d.proto.MotionFilterOptions.max_angle_radians)
}
...
#endif  // PROTOBUF_cartographer_2fmapping_5f2d_2fproto_2fmotion_5ffilter_5foptions_2eproto__INCLUDED
