...
static const float DISTANCE_MIN = 0.05f;        /**< meters */
...
static const int RS32_DATA_NUMBER_PER_SCAN =
  70000; // Set 70000 to be large enough
...
static const Config default_config = {.anglePath = "",
                                      .curvesPath = "",
                                      .channelPath = "",
                                      .curvesRatePath = "",
                                      .model = "RS16" };
...
public:
  ...
  void loadConfigFile(const rawdata::Config &config);

  /*unpack the RS16 UDP packet and opuput PCL PointXYZI type*/
  void unpack(const hardware::rslidar::msgs::RslidarPacket &pkt,
              pcl::PointCloud<pcl::PointXYZI>::Ptr pointcloud,
              bool finish_packets_parse);

  /*unpack the RS32 UDP packet and opuput PCL PointXYZI type*/
  void unpack_RS32(const hardware::rslidar::msgs::RslidarPacket &pkt,
                   pcl::PointCloud<pcl::PointXYZI>::Ptr pointcloud,
                   bool finish_packets_parse);
