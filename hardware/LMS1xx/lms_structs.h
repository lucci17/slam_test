 ...
 * @brief namespace for LMS1xx device
 */
namespace LASER
{
...
struct scanCfg {
   ...
   * 1/100 Hz
   */
  int32_t scaningFrequency;

  /*!
   * @brief Scanning resolution.
   * 1/10000 degree
   */
  int32_t angleResolution;
...
struct scanDataCfg {
   ...
   * Defines whether the remission values are output with 8-bit or 16bit
   * resolution.
   */
  int32_t resolution;
   ...
   */
  int32_t outputInterval;
};

/*!
* @class scanOutputRange
